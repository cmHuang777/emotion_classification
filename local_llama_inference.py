...
def generate_sentiment_prompt(text):
    return f"""
            This is an overall sentiment classifier for online tweets.
            ...
            Third, determine the overall SENTIMENT of INPUT as Positive or Negative or Neutral considering CLUES, the REASONING
...
outfile1 = "output/drone/local_llama3_70B/test/masked_all_tweets_llama3.csv"
outfile2 = "output/drone/local_llama3_70B/test/masked_all_tweets_llama3_raw.csv"
