...
del [model, tokenizer, peft_config, emotion_trainer, sentiment_trainer, bnb_config, training_arguments]
# del [df]
...
merged_model.save_pretrained("./finetuned_llama3_70B/emotion",safe_serialization=True, max_shard_size="2GB")
...
merged_model.save_pretrained("./finetuned_llama3_70B/sentiment",safe_serialization=True, max_shard_size="2GB")
